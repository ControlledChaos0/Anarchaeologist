...
#include "gameLevel1Background1.h"
...
void initLevel1() {
    ...
    DMANow(3, gameLevel1Background1Tiles, &CHARBLOCK[1], gameLevel1Background1TilesLen / 2);
    DMANow(3, gameLevel1Background1Map, &SCREENBLOCK[26], gameLevel1Background1MapLen / 2);
    ...
    currentCollisionMap = (unsigned short *) malloc(gameLevel1CollisionBitmapLen * sizeof(*currentCollisionMap));
    DMANow(3, gameLevel1CollisionBitmap, currentCollisionMap, gameLevel1CollisionBitmapLen / 2);
