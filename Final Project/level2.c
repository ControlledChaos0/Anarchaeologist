...
#include "gameLevel2Background1.h"
#include "gameLevel1Background2.h"
...
void initLevel2() {
    ...
    DMANow(3, gameLevel2Background1Tiles, &CHARBLOCK[1], gameLevel2Background1TilesLen / 2);
    DMANow(3, gameLevel2Background1Map, &SCREENBLOCK[26], gameLevel2Background1MapLen / 2);
    DMANow(3, gameLevel1Background2Tiles, &CHARBLOCK[2], gameLevel1Background2TilesLen / 2);
    DMANow(3, gameLevel1Background2Map, &SCREENBLOCK[28], gameLevel1Background2MapLen / 2);
    ...
    currentCollisionMap = (unsigned short *) malloc(gameLevel2CollisionBitmapLen * sizeof(*currentCollisionMap));
    DMANow(3, gameLevel2CollisionBitmap, currentCollisionMap, gameLevel2CollisionBitmapLen / 2);
...
void initBoxes2() {
    ...
    for (int i = 0; i < activeBoxes; i++) {
        ...
        moveableBlocks[i].worldCol = 40 + (24 * i);
